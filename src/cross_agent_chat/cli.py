...
MCP_INSTRUCTIONS: Final = (
    ...
    "unsolicited follow-up. That answer arrives later in this conversation as a new CAC message, "
    "so after sending, finish your turn; do not sleep, wait, or poll chat_status for it, which "
    "only delays its delivery. Classify the current incoming CAC message: an answer or result "
